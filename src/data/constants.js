...
export const skills = [
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "Grafana",
        image: "https://grafana.com/static/img/menu/grafana2.svg",
      },
      {
        name: "Prometheus",
...
export const experiences = [
  {
    ...
    desc: "Thirdfort is a platform integrating Know Your Customer (KYC), Anti-Money Laundering (AML), and payment fraud prevention, offering a web portal, mobile app, and secure APIs for integration.",
    skills: [
      "Golang",
      "JavaScript",
      "React",
    ...
    achievements: [
      "Drive revenue growth by 273% within a year for the Know Your Business (KYB) service",
      "Developed and maintained Customer Screening for PEP and sanctions verification",
      "Expanded address verification internationally by integrating Experian",
      "Designed and implemented red flag identification for source-of-funds verification",
      "Optimised system efficiency by extracting report generation into a standalone microservice",
      "Integrated Companies House data for KYB filings",
      "Implemented Pact contract testing for microservices",
      "Reduced support tickets by 30% by improving monitoring",
      "Led knowledge-sharing initiatives and mentoring",
    ],
  },
  {
    id: 1,
    ...
    desc: "Persistent Systems provides telecommunications solutions, specialising in SMS and messaging gateway technologies.",
    skills: [
      "Golang",
      "JavaScript",
      "Angular",
    ...
    achievements: [
      "Reduced system latency by 40% for Vodafone and IBM's control systems",
      "Developed automation solutions using Makefile and Bash scripts",
      "Enhanced cron job handling and concurrency management",
      "Redesigned Admin Portal UI using Angular, RxJS, and NgRx",
  ...
  },
  {
    ...
    desc: "GE Transportation's Train Coach Management System optimises goods transportation efficiency.",
    skills: [
      "Java",
      "Kotlin",
      "SQL",
    ...
    achievements: [
      "Improved system stability and performance of the Transportation Management System",
      "Modularised components to enhance maintainability",
      "Led R&D initiatives for Mass Data Management",
      "Optimised data processing pipelines",
    ],
  },
];
...
export const education = [
  {
    ...
    desc: "Bachelor of Science (Hons) Computer Science & Engineering degree from University of Moratuwa, Sri Lanka.",
    degree: "Bachelor of Science (Hons) Computer Science & Engineering",
  },
  {
    id: 1,
    ...
    desc: "Achieved highest nationwide marks in Mathematics.",
...
export const projects = [
  {
    ...
    achievements: [
      "Implemented high-concurrency message processing system",
      "Enhanced system reliability and scalability",
      "Improved message throughput and processing efficiency"
    ]
  },
  {
    id: 1,
    ...
    achievements: [
      "Developed efficient student database management system",
      "Implemented automated test analysis and reporting",
...
export const certifications = [
    {
        ...
        desc: "Professional certification in Google Cloud Platform architecture and design",
        link: "https://www.udemy.com/certificate/UC-696fa45d-bef0-40cb-8ca2-e5953ddd2c29/"
    },
    {
        id: 1,
        img: "https://www.udemy.com/staticx/udemy/images/v7/logo-udemy-inverted.svg",
    ...
    return bMonth - aMonth; // If years are equal, sort by month in descending order
});
